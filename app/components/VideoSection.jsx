...
const VideoSection = () => {
  return (
    <div className="w-full bg-navy-blue pt-40 pb-44 flex items-center px-32 justify-center flex-col">
        
        <div className="aspect-video w-[90%] mb-20 rounded-3xl shadow-sm bg-black">

        </div>

        <p className="text-[2.5rem] text-white font-extrabold leading-relaxed">
        ...
        <div className="max-w-[66rem] mt-10 mb-12 w-full py-12 px-24 rounded-3xl border border-theme-orange flex flex-col items-start justify-start gap-9">
