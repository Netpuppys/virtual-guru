...
// images
import interview from "../../public/whatYouGet/interview.png"
import interviewMastery from "../../public/whatYouGet/interviewMastery.png"
import linkedin from "../../public/whatYouGet/linkedin.png"
import purpose from "../../public/whatYouGet/purpose.png"
import resumeMaster from "../../public/whatYouGet/resumeMaster.png"
import streetsmart from "../../public/whatYouGet/streetsmart.png"

// comp 1
const subTitle =
  "Once you've taken the assessment, your journey begins with access to a suite of world-class career courses that are fully aligned with your personalized report. Here's what you'll receive:";
...
// comp 2
const subTitle2 =
  "Unlike other courses, CGP ACT is completely customized to your individual needs. Every participant begins with a comprehensive Career Growth Assessment. This powerful tool will generate a 32-page personalized report outlining:";
    ...
    <div className="w-full bg-navy-blue">
      <div className="w-full rounded-[3rem] px-6 lg:px-16 pb-20 bg-white flex flex-col items-center pt-16">
        <p className="tracking-wide text-navy-blue text-5xl text-center lg:text-left font-black mb-6 leading-snug md:leading-none">
          What You Get with{" "}
          <span className="text-theme-orange font-black">CGP ACT</span>
        </p>
        ...
        <div className="w-full mt-10 flex flex-wrap lg:gap-x-6 gap-y-6 lg:gap-y-10">
          {cards.map((item, index) => (
            <div
              className="rounded-xl group relative overflow-hidden w-full lg:w-[31%] aspect-[2/1]"
              key={index}
            >
              <Image
                src={item.image}
                ...
                alt={item.title}
              />
              <div className="absolute z-10 h-full bg-black bg-opacity-40 bottom-0 w-full pb-5 left-0 px-5 flex flex-col items-center justify-center">
                <div className="w-full flex items-center gap-3">
                  <p className="aspect-square bg-white rounded-full w-6 h-6 flex items-center justify-center mt-2">
                    <GiCheckMark />
                  </p>
                  <p className="text-white font-helveticaNow text-[16px] lg:text-[24px] font-bold">
                    {item.title}
                  </p>
                </div>
                <p className="text-white text-[14.4px] lg:text-[18px] leading-snug pl-[2.25rem] pt-2 text-wrap">
                  {item.para}
                </p>
              </div>
            </div>
      ...
      <div className="pt-16 lg:pt-32 pb-20 flex flex-col items-center justify-start px-[1.5rem] lg:px-20">
        ...
        <div className="w-full flex flex-col gap-7 max-w-[87rem] mt-12">
          {points.map((item, index) => (
            <div
              key={index}
              className="px-[0.8rem] lg:px-12 py-7 flex items-start gap-4 lg:gap-8 rounded-xl border border-white"
            >
